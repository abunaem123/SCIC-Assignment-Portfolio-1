        ...
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2 bg-slate-100 lg:py-28'>
                <div className='text-left px-5 md:pl-20'>
                    <h1 className='lg:text-7xl text-4xl text-slate-800 font-bold'>Hi <br /> I'm <span className='text-blue-900'>Abu Naem</span></h1>
                    ...
                    <button className='bg-blue-200 text-blue-900 px-6 py-3 font-semibold mt-8 rounded-lg' >
                        <a download="" href="http://localhost:3000/Update-Resume.pdf">Download</a>
                    </button>
                </div>
                <div>
